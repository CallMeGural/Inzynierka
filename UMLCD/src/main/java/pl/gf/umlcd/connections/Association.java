...
public class Association extends Group {
    ...
    public void showConnection(String id, ConnectionViewController controller) {
        ...
        if(data.getConnectedPairs().get(controller.getConnectionId()).getVBox1().getVBox().getChildren().size() == 5)
            label = (Label) data.getConnectedPairs().get(controller.getConnectionId()).getVBox1().getVBox().getChildren().get(0);
        else
            label = (Label) data.getConnectedPairs().get(controller.getConnectionId()).getVBox1().getVBox().getChildren().get(1);
        controller.getStartNameLabel().setText(label.getText());
        //End node
        if(data.getConnectedPairs().get(controller.getConnectionId()).getVBox2().getVBox().getChildren().size() == 5)
            label = (Label) data.getConnectedPairs().get(controller.getConnectionId()).getVBox2().getVBox().getChildren().get(0);
        else
            label = (Label) data.getConnectedPairs().get(controller.getConnectionId()).getVBox2().getVBox().getChildren().get(1);
